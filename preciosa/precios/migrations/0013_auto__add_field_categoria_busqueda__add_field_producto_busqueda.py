...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categoria.busqueda'
        db.add_column(u'precios_categoria', 'busqueda',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)

        # Adding field 'Producto.busqueda'
        db.add_column(u'precios_producto', 'busqueda',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Categoria.busqueda'
        db.delete_column(u'precios_categoria', 'busqueda')

        # Deleting field 'Producto.busqueda'
        db.delete_column(u'precios_producto', 'busqueda')
