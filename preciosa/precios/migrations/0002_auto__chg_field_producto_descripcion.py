...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'precios_producto', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Producto.descripcion'
        db.alter_column(u'precios_producto', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=100))
