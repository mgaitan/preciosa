...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Producto.UM_SM, Producto.UM_MR usamos los literales porque voy a eliminar
        # las constantes del modelo
        for p in orm.Producto.objects.filter(unidad_medida__in=('SM', 'MR')):
            p.unidad_medida = Producto.UM_M
            p.save(update_fields=['unidad_medida'])
