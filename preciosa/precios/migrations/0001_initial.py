...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'precios_categoria', (
        ...
        # Adding unique constraint on 'Marca', fields ['nombre', 'fabricante']
        db.create_unique(u'precios_marca', ['nombre', 'fabricante_id'])
        ...
        # Adding model 'EmpresaFabricante'
        ...
        # Adding unique constraint on 'Sucursal', fields ['direccion', 'ciudad']
        db.create_unique(u'precios_sucursal', ['direccion', 'ciudad_id'])

        # Adding model 'Precio'
        db.create_table(u'precios_precio', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Marca', fields ['nombre', 'fabricante']
        db.delete_unique(u'precios_marca', ['nombre', 'fabricante_id'])

        # Deleting model 'Categoria'
        db.delete_table(u'precios_categoria')
        ...
        # Deleting model 'Cadena'
        db.delete_table(u'precios_cadena')

        # Deleting model 'EmpresaFabricante'
        db.delete_table(u'precios_empresafabricante')

        # Deleting model 'Sucursal'
        db.delete_table(u'precios_sucursal')
