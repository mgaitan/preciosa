...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DescripcionAlternativa.busqueda'
        db.add_column(u'precios_descripcionalternativa', 'busqueda',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DescripcionAlternativa.busqueda'
        db.delete_column(u'precios_descripcionalternativa', 'busqueda')
