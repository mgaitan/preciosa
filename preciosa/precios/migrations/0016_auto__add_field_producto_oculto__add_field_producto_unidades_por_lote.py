...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Producto.oculto'
        db.add_column(u'precios_producto', 'oculto',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Producto.unidades_por_lote'
        db.add_column(u'precios_producto', 'unidades_por_lote',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Producto.oculto'
        db.delete_column(u'precios_producto', 'oculto')

        # Deleting field 'Producto.unidades_por_lote'
        db.delete_column(u'precios_producto', 'unidades_por_lote')
