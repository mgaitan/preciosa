...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sucursal.online'
        db.add_column(u'precios_sucursal', 'online',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sucursal.url'
        db.add_column(u'precios_sucursal', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Sucursal.direccion'
        db.alter_column(u'precios_sucursal', 'direccion', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting field 'Sucursal.online'
        db.delete_column(u'precios_sucursal', 'online')

        # Deleting field 'Sucursal.url'
        db.delete_column(u'precios_sucursal', 'url')


        # Changing field 'Sucursal.direccion'
        db.alter_column(u'precios_sucursal', 'direccion', self.gf('django.db.models.fields.CharField')(default=None, max_length=120))
