...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmpresaFabricante.logo_cropped'
        db.add_column(u'precios_empresafabricante', 'logo_cropped',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EmpresaFabricante.logo_changed'
        db.add_column(u'precios_empresafabricante', 'logo_changed',
                      self.gf('model_utils.fields.MonitorField')(default=datetime.datetime.now, monitor='logo'),
                      keep_default=False)

        # Adding field 'Marca.logo_cropped'
        db.add_column(u'precios_marca', 'logo_cropped',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Marca.logo_changed'
        db.add_column(u'precios_marca', 'logo_changed',
                      self.gf('model_utils.fields.MonitorField')(default=datetime.datetime.now, monitor='logo'),
                      keep_default=False)

        # Adding field 'Cadena.logo_cropped'
        db.add_column(u'precios_cadena', 'logo_cropped',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Cadena.logo_changed'
        db.add_column(u'precios_cadena', 'logo_changed',
                      self.gf('model_utils.fields.MonitorField')(default=datetime.datetime.now, monitor='logo'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmpresaFabricante.logo_cropped'
        db.delete_column(u'precios_empresafabricante', 'logo_cropped')

        # Deleting field 'EmpresaFabricante.logo_changed'
        db.delete_column(u'precios_empresafabricante', 'logo_changed')

        # Deleting field 'Marca.logo_cropped'
        db.delete_column(u'precios_marca', 'logo_cropped')

        # Deleting field 'Marca.logo_changed'
        db.delete_column(u'precios_marca', 'logo_changed')

        # Deleting field 'Cadena.logo_cropped'
        db.delete_column(u'precios_cadena', 'logo_cropped')

        # Deleting field 'Cadena.logo_changed'
        db.delete_column(u'precios_cadena', 'logo_changed')
