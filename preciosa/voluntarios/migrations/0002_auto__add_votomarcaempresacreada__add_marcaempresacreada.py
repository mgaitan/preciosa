...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VotoMarcaEmpresaCreada'
        db.create_table(u'voluntarios_votomarcaempresacreada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voluntarios.MarcaEmpresaCreada'])),
            ('voto', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'voluntarios', ['VotoMarcaEmpresaCreada'])

        # Adding model 'MarcaEmpresaCreada'
        db.create_table(u'voluntarios_marcaempresacreada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('marca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['precios.Marca'], null=True)),
            ('empresa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['precios.EmpresaFabricante'], null=True)),
        ))
        db.send_create_signal(u'voluntarios', ['MarcaEmpresaCreada'])


    def backwards(self, orm):
        # Deleting model 'VotoMarcaEmpresaCreada'
        db.delete_table(u'voluntarios_votomarcaempresacreada')

        # Deleting model 'MarcaEmpresaCreada'
        db.delete_table(u'voluntarios_marcaempresacreada')
    ...
    models = {
        ...
        u'voluntarios.votomarcaempresacreada': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['voluntarios.MarcaEmpresaCreada']"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
